...
type AuthorizationService struct {
	...
	UpdateAuthorizatioFn       func(context.Context, platform.ID, *platform.AuthorizationUpdate) error
}
...
func NewAuthorizationService() *AuthorizationService {
	return &AuthorizationService{
		...
		UpdateAuthorizatioFn:  func(context.Context, platform.ID, *platform.AuthorizationUpdate) error { return nil },
	}
}
...
func (s *AuthorizationService) UpdateAuthorization(ctx context.Context, id platform.ID, upd *platform.AuthorizationUpdate) error {
	return s.UpdateAuthorizatioFn(ctx, id, upd)
}
